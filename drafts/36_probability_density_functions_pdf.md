...
1. Set the total integral to 1:
   $$\int_{0}^{2} Cx^2 \, dx = 1$$
2. Integrate:
   $$C \left[ \frac{x^3}{3} \right]_0^2 = 1 \implies C \left( \frac{8}{3} - 0 \right) = 1 \implies C = \frac{3}{8}$$
3. Find the probability of a "Inner Circle" relative ($x > 1.5$) getting a box:
   $$P(1.5 < X < 2) = \int_{1.5}^{2} \frac{3}{8} x^2 \, dx = \frac{3}{8} \left[ \frac{x^3}{3} \right]_{1.5}^{2} = \frac{1}{8} [8 - 3.375] = \frac{4.625}{8} = 0.5781$$
...
1. Solve the integral:
   $$\left[ -e^{-0.2x} \right]_3^6 = (-e^{-1.2}) - (-e^{-0.6}) = -0.301 + 0.548 = 0.247$$
