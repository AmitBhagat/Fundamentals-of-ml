...
$$\begin{pmatrix} 1 & 1 \\ 1 & 1 \end{pmatrix} \begin{pmatrix} w_1 \\ w_2 \end{pmatrix} = 2 \begin{pmatrix} w_1 \\ w_2 \end{pmatrix} \implies w_1 = w_2 \implies v_1 = \begin{pmatrix} \frac{1}{\sqrt{2}} \\ \frac{1}{\sqrt{2}} \end{pmatrix}$$
...
**The Calculation:**
1. Characteristic Equation: $(3-\lambda)^2 - 1 = 0 \implies 3-\lambda = \pm 1$.
2. $\lambda_1 = 4, \lambda_2 = 2$.
3. For $\lambda_1 = 4$: $\begin{pmatrix} -1 & 1 \\ 1 & -1 \end{pmatrix} \begin{pmatrix} w_1 \\ w_2 \end{pmatrix} = 0 \implies w_1 = w_2$.
4. Ratio of Variance captured: $\frac{\lambda_1}{\lambda_1 + \lambda_2} = \frac{4}{4+2} = 66.7\%$.
