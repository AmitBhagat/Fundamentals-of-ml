...
$$\begin{pmatrix} -1 & 1 \\ 2 & -2 \end{pmatrix} \begin{pmatrix} v_1 \\ v_2 \end{pmatrix} = 0 \implies -v_1 + v_2 = 0 \implies \mathbf{v}_1 = \begin{bmatrix} 1 \\ 1 \end{bmatrix}$$
...
$$\det \begin{pmatrix} 2-\lambda & 0 \\ 0 & 9-\lambda \end{pmatrix} = (2-\lambda)(9-\lambda) = 0 \implies \lambda_1 = 2, \lambda_2 = 9$$
For $\lambda_2 = 9$:
$$\begin{pmatrix} 2-9 & 0 \\ 0 & 9-9 \end{pmatrix} \begin{pmatrix} v_1 \\ v_2 \end{pmatrix} = \begin{pmatrix} 0 \\ 0 \end{pmatrix} \implies -7v_1 = 0 \implies \mathbf{v}_2 = \begin{bmatrix} 0 \\ 1 \end{bmatrix}$$
...
$$1 - 2\lambda + \lambda^2 - 4 = 0 \implies \lambda^2 - 2\lambda - 3 = 0 \implies (\lambda-3)(\lambda+1) = 0$$
For $\lambda = 3$:
