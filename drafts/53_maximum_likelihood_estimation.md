...
$$8(1-p) = 2p \implies 8 - 8p = 2p \implies 10p = 8 \implies \hat{p} = 0.8$$
...
$$\frac{3+4+5}{\lambda} - 3 = 0 \implies \frac{12}{\lambda} = 3 \implies \hat{\lambda} = 4$$
...
$$(60 - \mu) + (100 - \mu) = 0 \implies 160 = 2\mu \implies \hat{\mu} = 80$$
