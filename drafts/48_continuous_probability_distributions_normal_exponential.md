...
$$P(X < 100) = \int_{-\infty}^{100} \frac{1}{20\sqrt{2\pi}} e^{-\frac{(t-120)^2}{2(20)^2}} dt \approx 0.1587$$
...
We find $P(X > 3)$:
$$P(X > 3) = 1 - P(X \le 3) = 1 - (1 - e^{-0.5 \times 3})$$
...
Given $B(8,2) = \frac{\Gamma(8)\Gamma(2)}{\Gamma(10)} = \frac{7! \cdot 1!}{9!} = \frac{1}{72}$:
$$P(X > 0.9) = 72 \int_{0.9}^1 (x^7 - x^8) dx = 72 \left[ \frac{x^8}{8} - \frac{x^9}{9} \right]_{0.9}^1 \approx 0.430$$
