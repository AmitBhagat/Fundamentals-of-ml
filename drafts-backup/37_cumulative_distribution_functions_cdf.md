...
**Calculation:**
$$F_X(3) = P(X \le 3) = \sum_{i=1}^{3} P(X=i)$$
$$F_X(3) = \frac{1}{21} + \frac{2}{21} + \frac{3}{21} = \frac{6}{21} \approx 0.285$$
...
**Calculation:**
The PDF is $f_X(x) = \frac{1}{10-2} = \frac{1}{8}$ for $2 \le x \le 10$.
$$F_X(5) = \int_{2}^{5} \frac{1}{8} dt$$
$$F_X(5) = \left[ \frac{t}{8} \right]_{2}^{5} = \frac{5}{8} - \frac{2}{8} = \frac{3}{8} = 0.375$$
...
$$F_X(3) = 0.5^1 + 0.5^2 + 0.5^3 = 0.5 + 0.25 + 0.125 = 0.875$$
