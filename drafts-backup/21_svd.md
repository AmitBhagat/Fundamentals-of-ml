...
2.  **Find Eigenvalues ($\lambda$) and Singular Values ($\sigma$):**
    $25 - \lambda = 0 \implies \lambda = 25$.
    $\sigma = \sqrt{25} = 5$.
    So, $\Sigma = \begin{bmatrix} 5 \end{bmatrix}$.
3.  **Find $V$:**
...
4.  **Find $U$:**
    ...
    Final SVD: $\begin{bmatrix} 3 \\ 4 \end{bmatrix} = \begin{bmatrix} 0.6 \\ 0.8 \end{bmatrix} [5] [1]$.
...
2.  **Find Eigenvalues:**
    ...
    Using the quadratic formula: $\lambda = \frac{3 \pm \sqrt{5}}{2}$.
...
2.  **Find Eigenvalues of $A A^T$:**
    $\det \begin{bmatrix} 2-\lambda & 1 \\ 1 & 2-\lambda \end{bmatrix} = (2-\lambda)^2 - 1 = 0 \implies \lambda_1=3, \lambda_2=1$.
